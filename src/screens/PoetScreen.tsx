      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.headerCard}>
          <View style={styles.headerBanner}>
            <Text style={styles.headerTitle}><MaterialCommunityIcons name="feather" size={18} /> {poet}</Text>
            <Text style={styles.headerSubtitle}>{data?.total || 0} nohas by this poet</Text>
          </View>
        </View>
        ...
        <View style={styles.listCard}>
          {!data || isLoading ? (
            ...
            <View style={styles.emptyState}><Text style={styles.emptyText}>No nohas found for this poet.</Text></View>
          )}
        </View>
